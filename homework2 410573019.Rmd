...
save(time_place,file="time_place")
...
"pokemon" <- Gamemaster[["pokemon"]]
"Jigglypuff" <- pokemon[[46]]
Jigglypuff[["Pudding"]] <- "Jigglypuff"
...
"mimikyu" <- list(
  ...
  chargedMoves= c("Dazzling Glem", "Disarming_Voice", "Gyro_Ball", "Play_Rough"),
  legacyMoves= c("BODY_SLAM",  "PLAY_ROUGH"),
  defaulIVs <- list(c(cp1500= "40,15,15,15", cp2500= "40,15,15,15"))
                         )
```
