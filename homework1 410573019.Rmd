...
```{r ans22}
# two_times
taiwantme <- ymd_hms("2019-4-12 12:55:30",tz="Asia/Tapei")
oslo_time <- ymd_hms("2018-11-18 15:33:02",tz="Europe/Lisbon")
```
...
```{r ans23}
# two_times_chicago
with_tz(taiwan_time, tzone="chicago")
with_tz(oslo_time, tzone="chicago")
```
...
# levels_fiveReceipts
levels(fiveReceipts)
object1 <- c(5,3,2,1,4,6,7,8,9,10)
save(object1, file="fiveReceipts")
```
### 4.2
