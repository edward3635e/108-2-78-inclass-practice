...
table_countsByArticle[pick_max] -> mostViolatedArticle
...
table(badEmployers$lawContent) -> lawContent
pick_max2 <- max(lawContent)== lawContent
lawContent[pick_max2] -> mostViolatedArticle_content
as.integer(mostViolatedArticle_content)
...
table(badEmployers$dt) -> dt
pick_max_dt <- max(dt) == dt
dt[pick_max_dt] -> popularSentenceMonth
